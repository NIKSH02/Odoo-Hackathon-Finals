...
const FacilityOwnerDashboard = () => {
  ...
  const earningsData = [
    { sport: 'Badminton', earnings: 15000, percentage: 100, color: 'bg-gray-900' },
    { sport: 'Tennis', earnings: 12000, percentage: 80, color: 'bg-gray-700' },
    { sport: 'Football', earnings: 8000, percentage: 53, color: 'bg-gray-500' },
    { sport: 'Basketball', earnings: 6000, percentage: 40, color: 'bg-gray-400' },
  ...
  const recentActivities = [
    { id: 1, action: 'New booking', details: 'Badminton Court 1 - 2PM to 4PM', time: '2 min ago', type: 'booking' },
    { id: 2, action: 'Payment received', details: '₹600 from John Doe', time: '15 min ago', type: 'payment' },
    { id: 3, action: 'Court maintenance', details: 'Tennis Court 2 scheduled', time: '1 hour ago', type: 'maintenance' },
    { id: 4, action: 'New booking', details: 'Football Ground - 6PM to 8PM', time: '2 hours ago', type: 'booking' }
  ];

  // Upcoming bookings data
  const upcomingBookings = [
    { id: 1, court: 'Badminton Court 1', time: '2:00 PM - 4:00 PM', customer: 'John Doe', amount: 600 },
    { id: 2, court: 'Tennis Court 1', time: '4:00 PM - 6:00 PM', customer: 'Jane Smith', amount: 800 },
    { id: 3, court: 'Football Ground', time: '6:00 PM - 8:00 PM', customer: 'Team Alpha', amount: 1200 },
    { id: 4, court: 'Basketball Court', time: '8:00 PM - 10:00 PM', customer: 'Mike Johnson', amount: 500 }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Earnings by Sport</h3>
            </div>
            <div className="h-64 flex flex-col justify-center space-y-4">
              {earningsData.map((item, index) => (
                <div key={index} className="flex items-center space-x-4">
                  <div className="w-20 text-sm font-medium text-gray-700">{item.sport}</div>
                  ...
                  <div className="w-16 text-sm font-semibold text-gray-900">₹{item.earnings.toLocaleString()}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-600">Create a new sports facility</p>
              </div>
            </button>
            <button
              onClick={() => navigate('/court-management')}
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-600">Add courts to existing venues</p>
              </div>
            </button>
